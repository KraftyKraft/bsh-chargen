...
const TWISTED_SCIENCE_MARVELS = [
  ...
  { name: "Firelance", meta: "6 inv. pts", effect: "As the name implies, a ranged weapon that spits fire at your enemies. Add Ud4 ongoing damage to a successful attack." },
  ...
  { name: "Gas mask", meta: "2 inv. pts", effect: "You'll excuse us if we don't follow the traditions of RPG writing and don't feel the need to always state the obvious: you know what a gas mask does." },
  ...
  { name: "Resurrection shot", meta: "4 inv. pts, single-use", effect: "The target doesn't have to roll on the Helpless table (page 18) but needs to roll a d20. On a result of 20, they die (probably in a gruesome way)." },
